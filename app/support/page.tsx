...
export default function SupportPage() {
  return (
    <>
      ...
      {/* The same banner faq and pricing use: plain white rather than the
          tinted default, centred, and set in the editorial face. This page was
          the only one of the three still on PageHeader's defaults, which made
          it read as belonging to a different site. */}
      <PageHeader
        tone="plain"
        align="center"
        titleFont="editorial"
        ...
        <Section tone="bg">
          <div className="mx-auto max-w-3xl">
            <Card data-reveal>
              ...
              <div className="mt-6">
                {/* The address is one unbreakable 30-character token, which is
                    wider than a 320px screen's content column once the pill's
                    padding is added. Allowed to break mid-word rather than push
              ...
              <p className="mt-6 text-sm leading-relaxed text-muted">
                ...
                opens an email already carrying your app version and iOS
                version, which is otherwise the first two replies of every
                conversation. Otherwise, tell us what you said, what came back,
                and roughly when.
              </p>
            </Card>
            ...
            <div data-reveal className="mt-8 grid gap-6 sm:grid-cols-2">
              <Card>
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted">
                  ...
                  on your device. Deleting the app does not cancel it, and
                  refunds are handled by Apple, so we cannot issue them.
                </p>
              </Card>
