...
const RATE_STEPS = [
  { text: "Consumer unit needs replacing.", name: "Replace consumer unit", unit: "job", price: "$640.00", tone: "blue" },
  { text: "Two double sockets in the kitchen.", name: "Double socket", unit: "each", price: "$90.00", tone: "amber" },
  { text: "An EV charger by the drive.", name: "EV charger install", unit: "job", price: "$780.00", tone: "green" },
  { text: "Four fire-rated downlights too.", name: "Fit downlights", unit: "each", price: "$55.00", tone: "blue" },
  { text: "Fault finding for the upstairs circuit.", name: "Fault finding", unit: "hour", price: "$65.00", tone: "amber" },
  { text: "Move the consumer unit outside.", name: "Consumer unit move", unit: "job", price: "$220.00", tone: "green" },
  { text: "Add a fused spur for the oven.", name: "Fused spur", unit: "each", price: "$145.00", tone: "blue" },
  { text: "Replace that pendant fitting.", name: "Pendant fitting", unit: "each", price: "$48.00", tone: "amber" },
  { text: "Run a new socket to the shed.", name: "External socket", unit: "each", price: "$110.00", tone: "green" },
  { text: "And a final safety check.", name: "Electrical inspection", unit: "job", price: "$180.00", tone: "blue" },
  { text: "Replace the bathroom extractor.", name: "Extractor fan", unit: "each", price: "$85.00", tone: "amber" },
  { text: "Put LED strips under the cabinets.", name: "LED strip lighting", unit: "metre", price: "$32.00", tone: "green" },
  { text: "A new outdoor security light.", name: "Security light", unit: "each", price: "$95.00", tone: "blue" },
  { text: "Swap the old board for an RCBO board.", name: "RCBO consumer unit", unit: "job", price: "$720.00", tone: "amber" },
  { text: "Wire a new induction hob in.", name: "Cooker connection", unit: "each", price: "$75.00", tone: "green" },
  { text: "Change the hallway switches over.", name: "Light switch", unit: "each", price: "$42.00", tone: "blue" },
  { text: "Add power for the garden office.", name: "Garden office supply", unit: "job", price: "$460.00", tone: "amber" },
  { text: "Replace that bathroom light fitting.", name: "Bathroom light", unit: "each", price: "$68.00", tone: "green" },
  { text: "Test the whole circuit before you go.", name: "Circuit testing", unit: "hour", price: "$65.00", tone: "blue" },
  { text: "Fit a new smoke alarm upstairs.", name: "Smoke alarm", unit: "each", price: "$48.00", tone: "amber" },
];
  ...
  return (
    <RateCardReveal>
      <Section id="rates" tone="charcoal" className="scroll-mt-24 !py-12 sm:!py-20">
        <div className="grid items-center gap-20 sm:gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
            ...
            <div className="rate-card-speech__stage">
              {RATE_STEPS.map((step) => (
                <div key={step.text} data-rate-speech className="rate-card-speech__line flex items-center justify-end gap-3 text-right">
                  <span data-rate-accent aria-hidden="true" className={`rate-card-accent rate-card-accent--${step.tone}`} />
                ...
                {RATE_STEPS.map((rate, index) => (
                  ...
                  >
                    <div data-rate-card className="rate-card-item">
                      ...
                      <span className="shrink-0 text-[15px] font-semibold tabular-nums text-[#e6eaec] sm:text-base">{rate.price}</span>
                    </div>
                  </div>
                ))}
              </div>
